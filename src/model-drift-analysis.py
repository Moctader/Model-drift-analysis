...
#from model_trainig import train_model, is_exists, update_model_results_to_database, deploy_model
import joblib
...
config = DICT_NAMESPACE({
    'input_pipeline_topic': 'post_processing',
    'output_pipeline_topic': 'model_retraining',
})
...
############################################################################################################
# Feteched data from the database   
def fetch_data_from_database():
    query = "SELECT * FROM data_engineering_key_space.stock_price_processed"
