...
import random
# from Linear_regression import train_model, is_exists, update_model_results_to_database, deploy_model
from LSTM import train_model, deploy_model, is_exists, update_model_results_to_database
